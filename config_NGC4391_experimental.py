...
#fit_paths = [f"NGC4391_{band}.fits" for band in bands]
fit_paths = None
...
coupling_path = "coupling_NGC4391_experimental.imfit"
...
"""
Custom wavelength-dependence functions. They should work similar to polynomial() in main file.
"""

def step(wavelengths, control_wavelengths, control_values):
	"""
	Piecewise-constant wavelength dependence.

	Each control wavelength defines the beginning of a new interval.
	"""
